...
class AuthRoute {
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}user/rate`, (0, validation_middleware_1.default)(general_dto_1.PaginationDto, 'query'), auth_middleware_1.default, this.authController.userListingRate);
