...
declare class AuthService {
    ...
    subscriptionToggleNotification(userId: string, reqData: NotificationSubscriptionDto): Promise<any>;
    ...
    userListingRate2(_: string, reqData: any, userId: any): Promise<any>;
